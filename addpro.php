<?php
  ...
  if(!empty($_POST['proName']) && !empty($_POST['proCat']) && !empty($_POST['proDes']) && !empty($_POST['proPrice']) && !empty($_POST['proPiec']) && !empty($_POST['addpro']))
  {
    ...
    if($check===0)
    {
      $sq = "INSERT INTO `product`(`product_name`,`category`,`product_description`,`price`,`piece`,`image`) VALUES('$proName','$proCat','$proDes','$proPrice','$proPiec','$proImg') ";
